...
inline PROTOBUF_ALWAYS_INLINE void Pong::set_msg(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.msg_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:node.Pong.msg)
}
inline std::string* Pong::mutable_msg() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Pong::set_allocated_msg(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
